...
@Component({
  selector: 'app-microsoft-authenticator',
  standalone: true,
  imports: [QRCodeModule, NavBarComponent, CommonModule, FormsModule, ReactiveFormsModule,MatInputModule, ToastrModule],
  templateUrl: './microsoft-authenticator.component.html',
  styleUrl: './microsoft-authenticator.component.css'
})
export class MicrosoftAuthenticatorComponent {
